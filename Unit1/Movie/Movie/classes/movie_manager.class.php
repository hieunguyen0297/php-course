 ...
 * Description: MovieManager class contains several methods that implement actions to handle Movie
objects. ctions include retrieving movies, searching for movies, adding new
movies, and editing or deleting existing movies.
 */
