 ...
 * Description: ListMovie class contains just one method named display. The method accepts an array of
Movie objects and displays titles, ratings, and release dates of all movies in a grid.
 */
